...
public class Uas {
    ...
    static final String DB_URL = "jdbc:mysql://localhost/uas";
    ...
    private static void create(Statement eksekusi, Scanner input) throws SQLException {
        ...
        System.out.print("Masukkan Category barang : ");
    ...
    private static void edit(Statement eksekusi, Scanner input) throws SQLException {
        ...
        System.out.print("Masukkan id Category barang yang baru: ");
        category = input.nextInt();
        ...
        if (category == 1 || category == 2 || category == 3) {
            ...
            String sql = "UPDATE product SET category_id = '" + category + "', description = '" + description + "', price = '"
